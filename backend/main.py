"""
ShockSmart backend — FastAPI + Random Forest
Zero pandas at runtime — pure numpy only to avoid StringDtype issues.
"""
...
def engineer(raw: dict) -> np.ndarray:
    ...
    d["any_prior"]      = float(any(d[c] for c in [
        "prior_reemergence_delirium","prior_htn_emergency",
